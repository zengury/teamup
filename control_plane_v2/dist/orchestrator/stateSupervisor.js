...
function deterministicFindings(current, event, transition) {
    const findings = [];
    ...
    const founderApprovalCommands = transition.commands.filter((command) => command.type === "request_approval" && command.requestedFrom === "founder");
...
export class MockStateSupervisor {
